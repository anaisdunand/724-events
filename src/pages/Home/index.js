        ...
        <main>
            ...
            <section id="nos-services" className="ServicesContainer">
                ...
                <div className="ListContainer">
                    <ServiceCard src="/images/priscilla-du-preez-Q7wGvnbuwj0-unsplash1.png">
                    ...
                    <ServiceCard src="/images/hall-expo.png">
                        <h3>Conférences</h3>
                        ...
                        l’évènementiel, nous saurons trouver le lieu parfait ainsi que des
                        solutions inédites pour capter votre audience et faire de cet
                        évènement un succès.
                    </ServiceCard>
                    <ServiceCard src="/images/sophia-sideri-LFXMtUuAKK8-unsplash1.png">
                        <h3>Expériences digitales</h3>
                        ...
                        évènementielle, de la veille technologique jusqu’au développement
                        de modules de formation innovant.
                    </ServiceCard>
                </div>
            </section>
            ...
            <section id="notre-equipe" className="PeoplesContainer">
                ...
                <div className="ListContainer">
                    <PeopleCard
                        src="/images/stephanie-liverani-Zz5LQe-VSMY-unsplash.png"
                        name="Samira"
                        position="CEO"
                    />
                    <PeopleCard
                        src="/images/linkedin-sales-solutions-pAtA8xe_iVM-unsplash.png"
                        name="Jean-baptiste"
                        position="Directeur marketing"
                    />
                    <PeopleCard
                        src="/images/christina-wocintechchat-com-SJvDxw0azqw-unsplash.png"
                        name="Alice"
                        position="CXO"
                    />
                    <PeopleCard
                        src="/images/jonas-kakaroto-KIPqvvTOC1s-unsplash.png"
                        name="Luís"
                        position="Animateur"
                    />
                    <PeopleCard
                        src="/images/amy-hirschi-b3AYk8HKCl0-unsplash1.png"
                        name="Christine"
                        position="VP animation"
                    />
                    <PeopleCard
                        src="/images/christina-wocintechchat-com-0Zx1bDv5BNY-unsplash.png"
                        name="Isabelle"
